...
var i_12490 = (self__.level + (1));
while(true){
if((i_12490 <= (new_level + (1)))){
(update[i_12490] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_12492 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12492[i]));
} else {
x__$2.forward.push((((i < links_12492.length))?(links_12492[i]):null));
}

if((i < links_12492.length)){
(links_12492[i] = x__$2);
} else {
links_12492.push(x__$2);
}
...
var i_12502 = (0);
while(true){
if((i_12502 <= self__.level)){
var links_12503 = (update[i_12502]).forward;
if((x__$1 === (((i_12502 < links_12503.length))?(links_12503[i_12502]):null))){
(links_12503[i_12502] = (x__$1.forward[i_12502]));

var G__12504 = (i_12502 + (1));
i_12502 = G__12504;
continue;
} else {
var G__12505 = (i_12502 + (1));
i_12502 = G__12505;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__12515 = nx;
var G__12516 = (level__$1 - (1));
x = G__12515;
level__$1 = G__12516;
continue;
} else {
var G__12517 = x;
var G__12518 = (level__$1 - (1));
x = G__12517;
level__$1 = G__12518;
continue;
}
